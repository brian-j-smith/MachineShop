...
tuned_model <- tune(fo, ICHomes, model = SVMRadialModel)
...
tuned_model <- tune(x, y, model = SVMRadialModel)
...
tuned_model <- tune(mf, model = SVMRadialModel)
...
tuned_model <- tune(rec, model = SVMRadialModel)
