...
tuned_model <- tune(fo, ICHomes, model = TunedModel(SVMRadialModel))
model_fit <- fit(fo, ICHomes, model = tuned_model)
...
tuned_model <- tune(x, y, model = TunedModel(SVMRadialModel))
model_fit <- fit(x, y, model = tuned_model)
...
tuned_model <- tune(mf, model = TunedModel(SVMRadialModel))
model_fit <- fit(mf, model = tuned_model)
...
tuned_model <- tune(rec, model = TunedModel(SVMRadialModel))
model_fit <- fit(rec, model = tuned_model)
