...
#> ModelRecipe grid:
#> # A tibble: 3 x 4
#>   name     selected params metrics$`C-Index`
#>   <chr>    <lgl>    <fct>              <dbl>
#> 1 Recipe.1 TRUE     1                  0.747
#> 2 Recipe.2 FALSE    2                  0.689
#> 3 Recipe.3 FALSE    3                  0.722
#> 
#> Selected grid row: 1
...
#>   name         selected params metrics$`C-Index`
#>   <chr>        <lgl>    <fct>              <dbl>
#> 1 GBMModel     TRUE     1                  0.753
#> 2 TunedModel   FALSE    2                  0.732
#> 3 StackedModel FALSE    3                  0.633
#> 
#> Selected grid row: 1
#> C-Index value: 0.7528376
```
