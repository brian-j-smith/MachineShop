...
Survival outcomes in recipes can be specified with the individual survival time and event variables given on the left hand side of the formula and with their roles designated as `"surv_time"` and `"surv_event"`, as shown below.
