...
Models may be specified with a traditional formula and data frame pair, as was done at the start of the survival example.  With this specification, `.` substitution of variables not already appearing in the formula may be used; in-line functions of predictor variables are not currently supported.
