...
`control`
  : object, control function, or character string naming a control function defining a default resampling method [default: ``"CVControl"``].
