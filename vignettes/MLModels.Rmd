...
- Return the fit object as a new inherited class with a call to `asMLModelFit` whose arguments are the object; a name for the new class of the form `"<Name>Fit"`; and the corresponding model object obtained with a call to its constructor with the same model parameters as originally supplied.
