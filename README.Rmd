...
Once installed, the following `R` commands will load the package and display its help system documentation.  Online documentation and examples are available at the [MachineShop main website](https://brian-j-smith.github.io/MachineShop).
